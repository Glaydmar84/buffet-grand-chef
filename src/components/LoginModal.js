...
export default function LoginModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70  flex items-start pt-10 h-full  justify-center z-50">
      <div className="relative bg-gray-900/70 h-[500px] backdrop-blur-md border border-white rounded-lg shadow-lg py-4 px-8  max-w-2xl">
        ...
        <form className="space-y-4">
         ...
         <hr className=" mt-8 bg-blue-500" ></hr>
              <p className=" text-sm ml-4  text-center text-white hover:underline">
                Ou faça o login com sua conta
              </p>
              <div>
              ...
              <div className="flex justify-center items-center">
                ...
                <button
                  type="submit"
                  className="px-4 py-1 mt-4                                                                                                                                                                                                                                                          w-full bg-gradient-to-r from-blue-500 to-purple-600  hover:from-blue-600 hover:to-purple-700  text-white font-semibold rounded-md shadow-md transition"
                >
                  Entrar
                </button>
        ...
        {/* Cadastre-se */}
        <p className="telative text-center w-full text-white mt-4">
          Não tem uma conta?{' '}
